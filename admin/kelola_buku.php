        ...
        <table class="data-table" style="min-width:920px;width:100%;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="book-cover-cell" style="width:40px;height:54px;flex-shrink:0;overflow:hidden;border-radius:4px;display:flex;align-items:center;justify-content:center;background:#1e2533;">
